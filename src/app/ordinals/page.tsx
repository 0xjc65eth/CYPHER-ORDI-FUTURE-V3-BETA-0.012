...
export default function OrdinalsPage() {
  ...
  useEffect(() => {
    const loadEcosystemStats = async () => {
      try {
        setIsLoading(true)
        console.log('📊 Loading Ordinals ecosystem stats...')
        const stats = await bitcoinEcosystemService.getEcosystemStats()
        setEcosystemStats(stats)
        console.log('✅ Loaded Ordinals ecosystem stats:', stats)
      } catch (error) {
          ...
          <div className="grid grid-cols-5 gap-4 mt-6">
            <div className="bg-muted/30 rounded-lg p-4 border bg-gradient-to-br from-orange-500/10 to-amber-500/10">
              ...
              {isLoading ? (
                ...
                <>
                  <p className="text-2xl font-bold mt-1">{ecosystemStats?.totalInscriptions.toLocaleString() || 'Loading...'}</p>
            ...
            <div className="bg-muted/30 rounded-lg p-4 border bg-gradient-to-br from-blue-500/10 to-purple-500/10">
              ...
              {isLoading ? (
                ...
                <>
                  <p className="text-2xl font-bold mt-1">₿{(ecosystemStats?.ordinalsVolume24h / 100000000 || 0).toFixed(1)}</p>
            ...
            <div className="bg-muted/30 rounded-lg p-4 border bg-gradient-to-br from-purple-500/10 to-pink-500/10">
              ...
              {isLoading ? (
                ...
                <>
                  <p className="text-2xl font-bold mt-1">{ecosystemStats?.totalOrdinals.toLocaleString() || 'Loading...'}</p>
