          ...
          <div className="grid grid-cols-5 gap-4 mt-6">
            ...
            <div className="bg-muted/30 rounded-lg p-4 border bg-gradient-to-br from-blue-500/10 to-purple-500/10">
              ...
              {isLoading ? (
                ...
                <>
                  <p className="text-2xl font-bold mt-1">₿{ordinalsStats?.total_volume_24h?.toFixed(1) || (ecosystemStats?.ordinalsVolume24h ? (ecosystemStats.ordinalsVolume24h / 100000000).toFixed(1) : '0.0')}</p>
