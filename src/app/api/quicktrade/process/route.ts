...
// V3.0.0 Fee Recipients
const DESTINATION_WALLETS = {
  // EVM Networks (same wallet for all EVM chains)
  ethereum: process.env.ETHEREUM_WALLET || '0x476F803fEA41CC6DfbCb3F4Ba6bAF462c1AD32AB',
  arbitrum: process.env.ARBITRUM_WALLET || '0x476F803fEA41CC6DfbCb3F4Ba6bAF462c1AD32AB',
  optimism: process.env.OPTIMISM_WALLET || '0x476F803fEA41CC6DfbCb3F4Ba6bAF462c1AD32AB',
  polygon: process.env.POLYGON_WALLET || '0x476F803fEA41CC6DfbCb3F4Ba6bAF462c1AD32AB',
  base: process.env.BASE_WALLET || '0x476F803fEA41CC6DfbCb3F4Ba6bAF462c1AD32AB',
  avalanche: process.env.AVALANCHE_WALLET || '0x476F803fEA41CC6DfbCb3F4Ba6bAF462c1AD32AB',
  bsc: process.env.BSC_WALLET || '0x476F803fEA41CC6DfbCb3F4Ba6bAF462c1AD32AB',
  // Solana Network
  solana: process.env.SOLANA_WALLET || 'EPbE1ZmLXkEJDitNb9KNu9Hq8mThS3P7LpBxdF3EkUwT'
};
...
function validateTradeRequest(request: ProcessTradeRequest): { valid: boolean; error?: string } {
  ...
  // Validar rede
  const supportedNetworks = ['ethereum', 'solana', 'arbitrum', 'optimism', 'polygon', 'base', 'avalanche', 'bsc'];
...
export async function POST(request: NextRequest) {
  try {
    ...
    const feeRecord: FeeRecord = {
      ...
      destinationWallet: DESTINATION_WALLETS[network as keyof typeof DESTINATION_WALLETS] || DESTINATION_WALLETS.ethereum,
      redirectUrl,
