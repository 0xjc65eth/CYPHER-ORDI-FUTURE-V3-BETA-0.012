      ...
      <div className="bg-gradient-to-br from-gray-950 via-gray-900 to-black">
              ...
              <div className="flex items-center space-x-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">Professional On-Chain Intelligence</p>
                  </div>
                </div>
        ...
        <div className="max-w-full mx-auto px-6 py-6">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <TabsList className="grid grid-cols-9 w-full bg-black/40 border border-white/10 h-12">
              {tabs.map((tab) => {
                const Icon = tab.icon;
                return (
                  <TabsTrigger 
                    key={tab.id} 
                    value={tab.id}
                    className="data-[state=active]:bg-blue-500 data-[state=active]:text-white text-gray-400 hover:text-white flex items-center space-x-2"
                  >
