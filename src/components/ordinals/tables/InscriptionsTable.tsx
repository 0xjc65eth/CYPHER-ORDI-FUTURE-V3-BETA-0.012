...
import { useInscriptionData } from '@/hooks/ordinals/useInscriptionData'
...
export function InscriptionsTable() {
  ...
  const { data: inscriptions, isLoading } = useInscriptionData({})
  ...
  const allInscriptions = generateMockInscriptions(10000)
  const ROW_HEIGHT = 64
