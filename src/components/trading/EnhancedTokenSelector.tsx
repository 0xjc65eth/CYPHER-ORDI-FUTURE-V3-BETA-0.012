...
const getEnhancedTokenData = (assetPrices: Record<string, any>): ExtendedToken[] => [
  // Ethereum Tokens
  {
    ...
    chainId: 1,
    isNative: true,
    price: assetPrices['ETH']?.price || 2350.45,
    priceChange24h: assetPrices['ETH']?.priceChange24h || 2.45,
    volume24h: assetPrices['ETH']?.volume24h || 8500000000,
    marketCap: assetPrices['ETH']?.marketCap || 282000000000,
    isPopular: true,
    verified: true,
  ...
  },
  {
    ...
    chainId: 1,
    price: assetPrices['USDC']?.price || 1.0,
    priceChange24h: assetPrices['USDC']?.priceChange24h || 0.01,
    volume24h: assetPrices['USDC']?.volume24h || 2400000000,
    marketCap: assetPrices['USDC']?.marketCap || 25000000000,
    isPopular: true,
    verified: true,
  ...
  },
  {
    ...
    chainId: 1,
    price: assetPrices['USDT']?.price || 1.0,
    priceChange24h: assetPrices['USDT']?.priceChange24h || -0.02,
    volume24h: assetPrices['USDT']?.volume24h || 1800000000,
    marketCap: assetPrices['USDT']?.marketCap || 96000000000,
    isPopular: true,
    verified: true,
  ...
  // Solana Tokens
  {
    ...
    chainId: 101,
    isNative: true,
    price: assetPrices['SOL']?.price || 98.76,
    priceChange24h: assetPrices['SOL']?.priceChange24h || 5.23,
    volume24h: assetPrices['SOL']?.volume24h || 1200000000,
    marketCap: assetPrices['SOL']?.marketCap || 42000000000,
    isPopular: true,
    verified: true,
  ...
  },
  {
    ...
    chainId: 101,
    price: assetPrices['USDC']?.price || 1.0,
    priceChange24h: assetPrices['USDC']?.priceChange24h || 0.0,
    volume24h: 580000000,
    isPopular: true,
    verified: true,
  ...
  // Bitcoin/Runes tokens (mock data)
  {
    ...
    chainId: 0, // Bitcoin
    price: assetPrices['GOODS']?.price || 0.0024,
    priceChange24h: assetPrices['GOODS']?.priceChange24h || 12.5,
    volume24h: 45000,
    isPopular: true,
    verified: true,
