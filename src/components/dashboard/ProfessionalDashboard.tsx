      ...
      <div className="max-w-7xl mx-auto px-6 py-6">
        ...
        {marketData && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <MetricCard
              title="Bitcoin Price"
              value={`$${marketData.bitcoin.price.toLocaleString()}`}
            ...
            <MetricCard
              ...
              value={marketData.ordinals.totalInscriptions.toLocaleString()}
              change={((marketData.ordinals.dailyInscriptions / marketData.ordinals.totalInscriptions) * 100)}
              icon={Globe}
              color="text-purple-400"
            />
            <MetricCard
              title="Active Runes"
              value={marketData.runes.activeRunes.toLocaleString()}
              change={5.2}
              icon={Zap}
              color="text-blue-400"
            />
            <MetricCard
              title="Mempool Fees"
              value={`${marketData.mempool.fees.fast} sat/vB`}
              icon={Clock}
