...
export const API_CONFIG = {
  ...
  hiro: {
    baseUrl: process.env.NEXT_PUBLIC_HIRO_API || 'https://api.hiro.so',
    endpoints: {
    ...
    apiKey: '3100ea7623797d267da3bd6dc94f47f9',
  },
  ...
  quicknode: {
    baseUrl: 'https://dry-spring-frost.btc.quiknode.pro/QN_828529b6ad4340a7afbe9e834d732277/',
    apiKey: 'QN_828529b6ad4340a7afbe9e834d732277',
    endpoints: {
