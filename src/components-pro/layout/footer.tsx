  ...
  return (
    <footer className="border-t border-zinc-800 bg-zinc-900/50 py-6">
      <div className="container grid gap-8 md:grid-cols-2 lg:grid-cols-4">
        <div>
          <h3 className="mb-3 text-lg font-semibold">CYPHER ORDI FUTURE</h3>
          <p className="text-sm text-zinc-400">
            Advanced Bitcoin analytics platform for Ordinals, Runes, and Mining with real-time insights.
          </p>
        </div>
        
        <div>
          <h4 className="mb-3 text-sm font-semibold uppercase text-zinc-400">Resources</h4>
        ...
        <div>
          <h4 className="mb-3 text-sm font-semibold uppercase text-zinc-400">Company</h4>
          <ul className="space-y-2 text-sm">
            <li>
        ...
        <div>
          <h4 className="mb-3 text-sm font-semibold uppercase text-zinc-400">Connect</h4>
          <div className="flex space-x-4">
            ...
            <Link href="https://discord.com" className="text-zinc-400 hover:text-white">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div className="mt-4">
            ...
            <div className="mt-2 flex">
              <input
                ...
                className="w-full rounded-l-md border border-zinc-700 bg-zinc-800 px-3 py-2 text-sm placeholder:text-zinc-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
              />
      ...
      <div className="container mt-8 border-t border-zinc-800 pt-6">
        <p className="text-center text-xs text-zinc-500">
          © {new Date().getFullYear()} CYPHER ORDI FUTURE. All rights reserved.
        </p>
      </div>
    </footer>
  )
